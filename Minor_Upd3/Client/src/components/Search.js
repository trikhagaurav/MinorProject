...
return (
  <Fragment>
    ...
    <br />
    <br /> <br /> <br />
    <div style={{background: "#ebf3f5",
  padding:"20px", width: "fit-content", borderRadius:"15px", justifyContent:"center",
  textAlign:"center",margin:"auto",}}>
    ...
    >
      ...
      {users.map((user) => (
        ...
        padding: "15px", width: "680px", borderRadius:"15px",justifyContent:"center",
        ...
        <Media as="li">
          ...
          />
          <Media.Body>
            <h7 style={{ marginRight: "5rem" }}><b>Report Date:</b> <Moment format="DD/MM/YYYY">{user.report_date}</Moment> </h7> 
            <h7><b>Report Type:</b> {user.reporttype}</h7> 
