module.exports = function(req, res, next){
    ...
    if (req.path === "/patientregister") {
      ...
      if (![ first_name ,last_name, mobile_number, phone_number, date_of_birth, blood_group, house_number, street, city, pincode, state, gender, username, password].every(Boolean)) {
        return res.json("Missing Credentials of patient");
      }
    ...
    if(req.path === "/register"){
        ...
        if([first_name, last_name, mobile_number, phone_number, speciality, hospital_name, gender, username, password, dob].every[Boolean]){
