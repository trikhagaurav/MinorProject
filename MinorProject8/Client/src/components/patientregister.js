...
const PRegister = ({ setAuth }) => {
  ...
  const { username, password, first_name, last_name, middle_name, mobile_number, phone_number, date_of_birth, blood_group, house_number, street, city, pincode, state, gender, marital_status, employeed } = inputs;
  ...
  const onSubmitForm = async (e) => {
    ...
    try {
      ...
      const body = { username, password, first_name, last_name, middle_name, mobile_number, phone_number, date_of_birth, blood_group, house_number, street, city, pincode, state, gender, marital_status, employeed }
          ...
          <div class="formreg">
            ...
            <Form.Row>
              <Form.Group as={Col} controlId="formGridDOB">
                ...
                <Form.Control value={date_of_birth} name="date_of_birth" type="date" onChange={e => onChange(e)} placeholder="DD/MM/YYYY" />
              </Form.Group>
              ...
              <Form.Group as={Col} controlId="formGridMobilePhone">
                ...
                <Form.Row>
                  <Form.Group as={Col} controlId="formGridMobilecode">
                    <Form.Control value="+91" type="text" fixed />
                  </Form.Group>
              ...
              <Form.Group as={Col} controlId="formGridPhone">
                ...
                <Form.Row>
                  <Form.Group as={Col} controlId="formGridPhonecode">
                    <Form.Control value="011" type="text" />
                  </Form.Group>
                  <Form.Group as={Col} controlId="formGridPhonenumber">
                    <Form.Control value={phone_number} name="phone_number" type="text" onChange={e => onChange(e)} placeholder="21345678" />
                  </Form.Group>
                </Form.Row>
              </Form.Group>
            ...
            <Row>
              <Col>
                <p className="forgot-password text-right">
                  Already registered ? <a href="http://localhost:3000/Patientlogin">sign in</a>
                </p>
              </Col>
            </Row>
          </div>
