module.exports = function(req, res, next){
    ...
    const {  first_name, middle_name, last_name, mobile_number, phone_number, date_of_birth, blood_group, house_number, street, city, pincode, state, gender, username, password,speciality,
        hospital_name, dob} = req.body;
  
    if (req.path === "/patientregister") {
      //console.log(!patient_id.length);
      if (![ first_name,middle_name ,last_name, mobile_number, phone_number, date_of_birth, blood_group, house_number, street, city, pincode, state, gender, username, password].every(Boolean)) {
